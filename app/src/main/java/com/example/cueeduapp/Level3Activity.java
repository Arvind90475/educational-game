...
public class Level3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        level3TimeView =  findViewById(R.id.level3TimeView);
    ...
    public void play_game(int perusal_time_by_seconds, String image_name) {
        ...
        new CountDownTimer(perusal_time_by_seconds * 1000, 1000){
            ...
            public void onTick(long millisUntilFinished) {
                level3TimeView.setText(String.format("TIME: %s", Long.toString(millisUntilFinished / 1000)));
            }
            @Override
            ...
            public void run() {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        level3TimeView.setText(String.format("TIME: %d", time_to_solve_puzzle));
                    }
                });
            }
        }, 1000, 1000);
    ...
    public void on_click_image(View v){
        ...
        if (num_of_clicks == 1) {
            ...
            if (Arrays.equals(correct_id_seq, rand_id_seq)) {
                ...
                dbHelper.insertPlayer(username, time_to_solve_puzzle, 3, "Duck");
