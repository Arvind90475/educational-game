...
public class Level2Activity extends AppCompatActivity {
    ...
    private final String BUTTON_NAME_PREFIX = "m";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        level2TimeView = findViewById(R.id.level2TimeView);
    ...
    public void play_game(int perusal_time_by_seconds, String image_name) {
        ...
        new CountDownTimer(perusal_time_by_seconds * 1000, 1000){
            ...
            public void onTick(long millisUntilFinished) {
                level2TimeView.setText(String.format("TIME: %s", Long.toString(millisUntilFinished / 1000)));
            }
            @Override
            ...
            public void run() {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        level2TimeView.setText(String.format("TIME: %d", time_to_solve_puzzle));
                    }
                });
            }
        }, 1000, 1000);
    ...
    public void on_click_image(View v){
        ...
        if (num_of_clicks == 1) {
            ...
            if (Arrays.equals(correct_id_seq, rand_id_seq)) {
                ...
                dbHelper.insertPlayer(username, time_to_solve_puzzle, 2, "Duck");
